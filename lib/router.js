...
// jkforum
router.get('/jkforum/qingliang', lazyloadRouteHandler('./routes/jkforum/qingliang.js'));

// picxx
router.get('/picxx/picture', lazyloadRouteHandler('./routes/picxx/picture.js'));

// 多摸鱼
router.get('/duomoyu/ranklist', lazyloadRouteHandler('./routes/duomoyu/ranklist.js'));

// 今日热榜
router.get('/tophub/:id', lazyloadRouteHandler('./routes/tophub/topDataList.js'));
